...
*    (c) 2020-2021 Daniel Menelkir - gitlab.com/menelkir/libg15
*
...
int setLEDs(unsigned int leds){
	...
	/* A little conversion is needed because the led bitmap for the
	 * G510 is completely different from the other keyboards.
	 * for g510 it is: bits 0-3 = N/A; bit 4 = MR;
	 * bit 5 = M1; bit 6 = M2; bit 7 = M3; */
